...
public class ViewActivity extends AppCompatActivity {
    ...
    public void SearchMachineButton(View view) {
        machine_id = (EditText) findViewById(R.id.machine_id_to_search);
        displayDatabaseInfo();
    }

    private void displayDatabaseInfo() {
        String mString = machine_id.getText().toString().trim();
        ...
        String selection = ErrorEntry.COLUMN_MACHINE_ID + "=?";
        String[] selectionArgs = {mString};
        Cursor cursor = db.query(
                ErrorEntry.TABLE_NAME,
                projection,selection,selectionArgs,null,null,null);
        TextView displayView = (TextView) findViewById(R.id.view_machine_error);
